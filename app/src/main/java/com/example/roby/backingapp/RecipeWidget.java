...
public class RecipeWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences(Utils.PREF_RECIPE_NAME, Context.MODE_PRIVATE);
        String widgetText = sharedPreferences.getString(Utils.PREF_RECIPE_NAME, "");
